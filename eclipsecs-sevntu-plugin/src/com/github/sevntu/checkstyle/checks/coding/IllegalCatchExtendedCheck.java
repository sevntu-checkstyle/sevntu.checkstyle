...
public final class IllegalCatchExtendedCheck extends AbstractIllegalCheck
{
	...
	public void visitToken(DetailAST aDetailAST)
	{
		...
		final boolean noWarning = (throwAST != null && firstLvlChild != null && secondLvlChild != null
				...
				&& ((mAllowRethrow && secondLvlChild.getType() == TokenTypes.IDENT)
				|| (mAllowThrow && secondLvlChild.getType() == TokenTypes.LITERAL_NEW)));
	 ...
	 * @return null if the "throw" keyword was not found or the LITERAL_THROW DetailAST otherwise
	 */
	 ...
	 * @param aNode
	 *            - current parent node.
	 * @return an array of childs one level below on the current parent node aNode.
	 */
