...
/**
 * <p>
 * Checks that interface type parameter names conform to a format specified by
 * the format property. The format is a {@link java.util.regex.Pattern regular
 * expression} and defaults to <strong>^[A-Z]$</strong>.
 * </p>
 * <p>
