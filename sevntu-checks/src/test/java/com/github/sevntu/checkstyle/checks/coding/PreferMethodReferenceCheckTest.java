...
public class PreferMethodReferenceCheckTest extends AbstractModuleTestSupport {
    ...
    public void testMethodCallsNoExpressions() throws Exception {
        ...
        verify(checkConfig, getPath("InputPreferMethodReferenceCheck1.java"), expected);
    }
    ...
    public void testMethodCallsOnEverything() throws Exception {
        ...
        verify(checkConfig,
            getPath("InputPreferMethodReferenceCheck2.java"),
            expected);
    }
    ...
    public void testStatementsListsWithExpressions() throws Exception {
        ...
        verify(checkConfig,
            getPath("InputPreferMethodReferenceCheck3.java"),
            expected);
    }
    ...
    public void testObjectCreation() throws Exception {
        ...
        verify(checkConfig, getPath("InputPreferMethodReferenceCheck4.java"), expected);
    }
