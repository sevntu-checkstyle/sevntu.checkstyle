...
public class MapIterationInForEachLoopTest extends BaseCheckTestSupport
{
    ...
    public final void basicTest() throws Exception
    {
        ...
        final String[] expected = {
            "22:25: " + getCheckMessage(mMsgKeyEntrySet),
            "45:25: " + getCheckMessage(mMsgKeyValues),
            "47:33: " + getCheckMessage(mMsgKeyKeySet),
            "71:33: " + getCheckMessage(mMsgKeyEntrySet),
            "76:25: " + getCheckMessage(mMsgKeyKeySet),
            "83:17: " + getCheckMessage(mMsgKeyEntrySet),
            "88:17: " + getCheckMessage(mMsgKeyValues), };
    ...
    public final void importsWithoutFullPathTest() throws Exception
    {
        ...
        final String supportedMapImplQualifiedNames = "java.util.Map, "
