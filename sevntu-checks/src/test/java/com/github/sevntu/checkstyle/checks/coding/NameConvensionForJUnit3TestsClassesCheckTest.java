 ...
 */
public class NameConvensionForJUnit3TestsClassesCheckTest extends BaseCheckTestSupport
{

    private final String msgClass = getCheckMessage(
            NameConvensionForJUnit3TestsClassesCheck.MSG_KEY);

    private final DefaultConfiguration mCheckConfig = createCheckConfig(
            NameConvensionForJUnit3TestsClassesCheck.class);
    ...
    public void testAttribute() throws Exception
    {
        ...
        mCheckConfig.addAttribute("inheritingClass", "FF");
