...
public class InputRequireFailForTryCatchInJunitCheckTruthStarImport {
    ...
    public void validAssertWithMessageChained() {
        try {
            obj.toString();
            Truth.assert_().withMessage("simple message").fail();
        }
        catch (Exception expected) {
            assertThat(expected).isInstanceOf(NullPointerException.class);
        }
    ...
    private InputRequireFailForTryCatchInJunitCheckTruthStarImport chain() {
        return this;
    }
