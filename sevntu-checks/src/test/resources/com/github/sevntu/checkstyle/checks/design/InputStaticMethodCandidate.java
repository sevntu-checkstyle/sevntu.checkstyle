...
public class InputStaticMethodCandidate extends ClassB {
    ...
    private static class Nested {
        ...
        private void nestedFoo1() {    //violation
            InputStaticMethodCandidate local = new InputStaticMethodCandidate();
            InputStaticMethodCandidate.classField = local.instanceField;
...
class TestExtended extends InputStaticMethodCandidate {
    static {int i = 1;}
