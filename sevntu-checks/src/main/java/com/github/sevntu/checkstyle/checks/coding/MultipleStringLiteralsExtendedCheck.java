...
public class MultipleStringLiteralsExtendedCheck extends Check
{
	...
	{
		for (DetailAST token = aAST; token.getParent() != null; token = token.getParent())
		{
