 ...
 */
public class LineLengthWithIgnoreCheck extends Check {
     ...
     */
    public LineLengthWithIgnoreCheck() {
        setIgnorePattern("^$");
    }
     ...
     */
    public final void setIgnorePattern(String aFormat) throws ConversionException {
        try {
