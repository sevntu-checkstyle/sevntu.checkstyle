...
public class LineLengthWithIgnoreCheckTest extends BaseCheckTestSupport
{
	@Test
        ...
        throws Exception
    {
        final DefaultConfiguration checkConfig =
            createCheckConfig(LineLengthWithIgnoreCheck.class);
       ...
       verify(checkConfig, getPath("sizes" + File.separator + "InputSimple.java"), expected);
    }
